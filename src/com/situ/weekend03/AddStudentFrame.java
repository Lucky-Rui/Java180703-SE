...
public class AddStudentFrame extends JFrame {
	...
	public AddStudentFrame(List<Student> list, MainFrameS mainFrameS) {
		this.list = list;
	...
	public void init() {
		...
		saveButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				Student student = new Student(list.size() + 1, name, age, gender);
				list.add(student);
				StudentIO studentIO = new StudentIO();
				studentIO.save(list);
				mainFrameS.reloadTable();
				mainFrameS.selectlist = studentIO.loadDate();
				// 保存成功或者失败，弹出提示框
